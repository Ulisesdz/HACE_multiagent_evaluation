...
class HybridScorer:
    ...
    def calculate_final_score(
        ...
        layer3_used = layer3_results is not None and layer3_results.get(
        ...
        if layer3_used:
            ...
            layer3_score = (
                layer3_results.get("overall_score", 2.0) / 4
            )  # Normalizar a 0-1
        ...
        confidence = self._assess_confidence(
            layer1_results, layer2_results, layer3_results, layer3_used
        )
    ...
    def _get_weights_used(self, layer3_used: bool) -> Dict[str, float]:
        ...
        if layer3_used:
            ...
            return {"layer1": 0.4, "layer2": 0.6, "layer3": 0.0}
