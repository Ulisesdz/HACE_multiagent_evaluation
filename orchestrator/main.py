...
def main():
    ...
    print("="*50)
    print("Roles Activos:")
    print(f" {COLORS['Technical_Analyst']}• Technical Analyst{COLORS['RESET']} (Quant, ML, Gráficos)")
    print(f" {COLORS['Fundamental_Analyst']}• Fundamental Analyst{COLORS['RESET']} (Noticias, RAG)")
    print(f" {COLORS['Risk_Officer']}• Risk Officer{COLORS['RESET']} (Volatilidad, Seguridad)")
            ...
            for chunk in app.stream(inputs):
                ...
                for key, value in chunk.items():
                    ...
                    if "messages" in value:
                        ...
                        print(f"{agent_color}  └─ Respuesta:{COLORS['RESET']} {content}\n")
